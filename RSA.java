...
public class RSA {
	...
	public String openFromDiskPublicKeyString(String path) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
		String content = this.readFileAsString(path);
		
		byte[] encodedPublicKey = stringToBytes(content);
	...
	public String openFromDiskPrivateKeyString(String path) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
		String content = this.readFileAsString(path);
		
		byte[] encodedPrivateKey = stringToBytes(content);
